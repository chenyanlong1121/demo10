...
public interface MissionDao {
     ...
     * @return 对象列表
     */
    List<Mission> queryAllBydate(@Param("date1") String date1, @Param("date2") String date2,@Param("model_id") Integer model_id,@Param("excel_name") String excel_name);
    /**
     * 查询所有
     *
     * @return 对象列表
    ...
    List<String> queryBydirector(String director,String excel_name,@Param("date1") String date1, @Param("date2") String date2);
